// wfx: trigger shadow-sm removed (static control, border only); content
// shadow-md -> shadow-float (dropdown = floating surface, design-system.md §4);
// highlighted-item chrome uses bg-chrome, not bg-accent (accent is reserved lime, D-F04)
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-2 pr-8 text-sm outline-none focus:bg-chrome focus:text-chrome-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      className
    )}
    {...props}
  >
